...
def list_orders(status: Optional[str] = None, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    ...
    for o in orders:
        ...
        data = {
            ...
            "occasion": o.occasion,
            "status": o.status.value if hasattr(o.status, 'value') else (o.status or "Order Received"),
            "priority": o.priority.value if hasattr(o.priority, 'value') else (o.priority or "Medium"),
            "due_date": o.due_date,
